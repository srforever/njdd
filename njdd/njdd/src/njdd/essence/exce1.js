(function (window) {
    $(document).ready(function () {
        ...
        //    // 绘制类型(polyline or polygon)，控制画面或者画线
        //    var drawType;
        ...
        //    /**
        //    * 获取用户的位置并回调dealFunc进行处理
        //    * @param   dealFunc {Function}   待回调的函数,成功获取到用户位置时回调
        //    */
        ...
        //            if (graphicClickType == "DELETE") {
        //                gml = convertToWkt(graphicLayer.graphics);
        //            }
